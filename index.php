  ...
  <div class="body">
    <div class="container" id="container">
      ...
      <div class="container mt-3 mb-4 text-center">
        <a href="galeria.html" class="btn btn-primary rounded-5 btn-lg text-white fw-bold">GALÉRIA</a>
      </div>
    </div>
        ...
        <div class="card-body text-center">
          <figure class="text-center">
            <blockquote class="blockquote">
              <p>
                "Skutočné cestovanie nie je hľadanie nových krajín, ale nových očí."</p>
            </blockquote>
